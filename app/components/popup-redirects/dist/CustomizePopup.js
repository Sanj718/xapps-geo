    ...
    return react_1["default"].createElement(polaris_1.InlineGrid, { columns: { xs: "1fr", md: "1.5fr 3fr" }, gap: "400" },
                    ...
                    react_1["default"].createElement(polaris_1.InlineGrid, { gap: "300" },
                        ...
                        react_1["default"].createElement(polaris_1.InlineGrid, { gap: "200" },
                            ...
                            react_1["default"].createElement(polaris_1.InlineGrid, { gap: "200", columns: "2" },
                                ...
                                react_1["default"].createElement(polaris_1.Select, { disabled: isFreePlan, label: "Layout", options: [
                                        {
                                            label: "Grid",
                                            value: "grid"
                                        },
                                        ...
                                        ? function (value) {
                                            return setConfigs(function (current) { return (__assign(__assign({}, current), { layout: value })); });
                                        }
                                        : undefined, value: (configs === null || configs === void 0 ? void 0 : configs.layout) ? configs.layout : "" }),
                                (configs === null || configs === void 0 ? void 0 : configs.layout) === "dropdown" ? (react_1["default"].createElement(polaris_1.InlineGrid, null,
                                    react_1["default"].createElement(polaris_1.InlineStack, { align: "space-between", gap: "200", blockAlign: "center" },
                                        react_1["default"].createElement(polaris_1.Text, { as: "p" }, "Label"),
                                        react_1["default"].createElement(polaris_1.Tooltip, { content: "Translate your content into multiple languages supported by your store." },
                                            react_1["default"].createElement(polaris_1.Button, { icon: polaris_icons_1.LanguageIcon, size: "micro", onClick: function () { return shopify.modal.show("dropdown-label-translation-popup"); } }))),
                                    react_1["default"].createElement(polaris_1.TextField, { size: "slim", label: "Dropdown label", labelHidden: true, onChange: !isFreePlan
                                            ? function (value) {
                                                return setConfigs(function (current) { return (__assign(__assign({}, current), { dropdownPlaceholder: value })); });
                                            }
                                            : undefined, value: (configs === null || configs === void 0 ? void 0 : configs.dropdownPlaceholder) ? configs.dropdownPlaceholder
        ...
        react_1["default"].createElement("div", { className: "ngr-inner-preview" },
            react_1["default"].createElement(RedirectsPopupPreview_1["default"], { redirects: isProPlan
                    ...
                    ? configs
                    : __assign(__assign({}, _helpers_1.default_basic_configs), { title: configs === null || configs === void 0 ? void 0 : configs.title, icon: configs === null || configs === void 0 ? void 0 : configs.icon, buttonText: configs === null || configs === void 0 ? void 0 : configs.buttonText, showFlag: configs === null || configs === void 0 ? void 0 : configs.showFlag }), advancedConfigs: isProPlan ? advancedConfigs : {} })));
}
exports["default"] = CustomizePopup;
