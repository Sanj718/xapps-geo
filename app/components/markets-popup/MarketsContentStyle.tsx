...
} from "../../../helpers/process-client-response";
...
import { MarketsWidgetPreview } from "../MarketsWidgetPreview";
...
export default function MarketsContentStyle({
  ...
  async function saveConfigs() {
    ...
    try {
      const response = await fetch(SET_MARKET_CONFIGS, {
        headers: {
            ...
            <>
              <BlockStack gap="200">
                  ...
                  <InlineStack gap="150">
                    <div className="icon-upload">
                      ...
                      <ImageManager
                        ...
                        typeSingleCallback={
                          !isFreePlan ? handleCustomIconUpload : undefined
                        }
                      />
                    </div>
                    <Tooltip
                ...
                <InlineGrid gap="400">
                  ...
                  <Select
                    disabled={isFreePlan}
                    label="Selectors display"
                    options={[
                      { label: "Country selector", value: "country" },
                      {
                        label: "Language selector",
                        value: "language",
                      },
                      {
                        label: "Country & language selector",
                        value: "both",
                      },
                    ]}
                    onChange={
