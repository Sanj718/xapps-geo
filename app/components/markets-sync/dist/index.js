...
var lineReader_server_cjs_1 = require("./lineReader.server.cjs");
...
var MarketsProcess = /** @class */ (function () {
    ...
    MarketsProcess.prototype.initSync = function (session, bulk_id) {
        return __awaiter(this, void 0, void 0, function () {
            var bulkResponse, url, status, errorCode, fileName, pipeline, lineR, _self_1, error_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, admin_queries_server_js_1.getBulkOperation({ admin: session, bulkId: bulk_id })];
                    case 1:
                        ...
                        // console.log('initSync', JSON.stringify(bulkResponse?.body?.data))
                        if (status === "RUNNING") {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this..call(this, fileName)];
                    case 3:
                        _a.sent();
                        lineR = new lineReader_server_cjs_1["default"](path_1.resolve() + fileName, {
                            skipEmptyLines: true
                        });
