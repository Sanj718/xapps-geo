...
exports.action = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _b, payload, session, topic, shop, current;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, shopify_server_1.authenticate.webhook(request)];
                case 1:
                    _b = _c.sent(), payload = _b.payload, session = _b.session, topic = _b.topic, shop = _b.shop;
                ...
                case 2:
                    _c.sent();
                    _c.label = 3;
                case 3: return [2 /*return*/, new Response()];
            }
        });
    });
};
