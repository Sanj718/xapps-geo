...
var _helpers_1 = require("../../components/_helpers"); // import { getEmbedConst, isJson, defaultState } from "app/components/_helpers";
...
var _a = _helpers_1.getEmbedConst(env_1.PROD_EMBED_APP_ID, env_1.DEV_EMBED_APP_ID, env_1.MK_EMBED_APP_HANDLE) || {},
    EMBED_APP_ID = _a.EMBED_APP_ID,
    EMBED_APP_HANDLE = _a.EMBED_APP_HANDLE; // [TODO] find correct way to add ts check here.


exports.loader = function (params) {
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      return [2
      /*return*/
      , _loaders_1.handleLoaders(params)];
    });
  });
};

exports.action = function (params) {
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      return [2
      /*return*/
      , _actions_1.handleActions(params)];
    });
  });
};
...
function MarketsRedirects() {
  ...
  var _e = react_2.useOutletContext(),
      shopInfo = _e.shopInfo,
      shopdb = _e.shopdb,
      activePlan = _e.activePlan,
      devPlan = _e.devPlan,
      veteranPlan = _e.veteranPlan,
      appId = _e.appId,
      appData = _e.appData;

  var _f = _helpers_1.planParser(activePlan),
      isProPlan = _f.isProPlan,
      isBasicPlan = _f.isBasicPlan,
      isFreePlan = _f.isFreePlan;

  var _g = react_2.useLoaderData(),
      marketsConfigs = _g.marketsConfigs,
      marketsData = _g.marketsData;

  var _h = react_2.useSearchParams(),
      searchParams = _h[0],
      setSearchParams = _h[1]; // const { basicConfigs, advancedConfigs, hideOnAllowedPages, allowedPages } = configs?.data[0] || {}
  ...
  var _j = react_1.useState(true),
      initialLoading = _j[0],
      setInitialLoading = _j[1];

  var _k = react_1.useState(null),
      secondaryLocales = _k[0],
      setSecondaryLocales = _k[1];

  var _l = react_1.useState(_helpers_1.defaultState),
      toastData = _l[0],
      setToastData = _l[1];

  var _m = react_1.useState(false),
      marketsSyncLoading = _m[0],
      setMarketsSyncLoading = _m[1];

  var _o = react_1.useState(0),
      selectedTab = _o[0],
      setSelectedTab = _o[1]; // const [marketsPopup, setMarketsPopup] = useState(false);
  ...
  var _q = react_1.useState(false),
      refetchSettings = _q[0],
      setRefetchSettings = _q[1];

  var _r = react_1.useState(null),
      active = _r[0],
      setActive = _r[1];

  var _s = react_1.useState(__assign(__assign({}, _helpers_1.default_markets_basic_configs), (_a = marketsConfigs === null || marketsConfigs === void 0 ? void 0 : marketsConfigs.data) === null || _a === void 0 ? void 0 : _a.basicConfigs)),
      localConfigs = _s[0],
      setLocalConfigs = _s[1];

  var _t = react_1.useState(__assign(__assign({}, _helpers_1.default_advanced_configs), (_b = marketsConfigs === null || marketsConfigs === void 0 ? void 0 : marketsConfigs.data) === null || _b === void 0 ? void 0 : _b.advancedConfigs)),
      localAdvancedConfigs = _t[0],
      setLocalAdvancedConfigs = _t[1]; // useMemo(() => {
  ...
  function handleMarketsSync() {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        if (!(shopdb === null || shopdb === void 0 ? void 0 : shopdb.id)) return [2
        /*return*/
        ];
  ...
  }, [searchParams]); // console.log("marketsConfigs: ", marketsConfigs, localConfigs, localAdvancedConfigs);

  return react_1["default"].createElement(polaris_1.Page, null, react_1["default"].createElement("div", {
    id: "main-screen"
  }, react_1["default"].createElement(PageTitle_1.PageTitle, {
    icon: polaris_icons_1.MarketsIcon,
    title: "Markets redirects",
    status: active,
    loading: false,
    embedPath: EMBED_APP_ID + "/" + EMBED_APP_HANDLE
  }), react_1["default"].createElement("br", null), react_1["default"].createElement(polaris_1.Tabs, {
    tabs: mainTabs,
    ...
    fitted: true
  }, react_1["default"].createElement("br", null), selectedTab === 0 ? react_1["default"].createElement(polaris_1.BlockStack, {
    gap: {
      xs: "800",
      sm: "400"
    }
  }, react_1["default"].createElement(MarketsPopupControls_1["default"], {
    marketsData: marketsData === null || marketsData === void 0 ? void 0 : marketsData.data,
    marketsSync: handleMarketsSync,
    marketsSyncLoading: marketsSyncLoading,
    marketsPopup: (_c = marketsConfigs === null || marketsConfigs === void 0 ? void 0 : marketsConfigs.data) === null || _c === void 0 ? void 0 : _c.widget
  }), smUp ? react_1["default"].createElement(polaris_1.Divider, null) : null, react_1["default"].createElement(MarketsContentStyle_1["default"], {
    marketsData: marketsData,
    configs: localConfigs,
    advancedConfigs: localAdvancedConfigs
  }), smUp ? react_1["default"].createElement(polaris_1.Divider, null) : null, react_1["default"].createElement(MarketsPopupDisplaySettings_1["default"], {
    configs: localConfigs,
    setConfigs: setLocalConfigs,
    advancedConfigs: localAdvancedConfigs
  }), smUp ? react_1["default"].createElement(polaris_1.Divider, null) : null, react_1["default"].createElement(MarketsOtherSettings_1["default"], null)) : "", selectedTab === 1 ? react_1["default"].createElement(polaris_1.BlockStack, {
    gap: {
      xs: "800",
      sm: "400"
    }
  }, react_1["default"].createElement(MarketsAutoControls_1["default"], {
    marketsData: marketsData === null || marketsData === void 0 ? void 0 : marketsData.data,
    marketsSync: handleMarketsSync,
    marketsSyncLoading: marketsSyncLoading,
    marketRedirect: (_d = marketsConfigs === null || marketsConfigs === void 0 ? void 0 : marketsConfigs.data) === null || _d === void 0 ? void 0 : _d.autoRedirect
  }), smUp ? react_1["default"].createElement(polaris_1.Divider, null) : null, react_1["default"].createElement(MarketsAutoSettings_1["default"], null)) : ""), react_1["default"].createElement("br", null)));
}
