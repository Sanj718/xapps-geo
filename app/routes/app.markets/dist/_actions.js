        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    if (!(_action === _actions_1.ACTIONS.run_MarketsSync)) return [3 /*break*/, 4];
                    return [4 /*yield*/, admin_queries_server_1.runMarketsSync({ admin: admin, data: data })];
                case 3:
                    response = _d.sent();
                    return [2 /*return*/, __assign({ _action: _action }, response)];
                case 4:
                    if (!(_action === _actions_1.ACTIONS.update_MarketsConfigs)) return [3 /*break*/, 6];
                    return [4 /*yield*/, db_queries_server_1.createUpdateMarketConfigs(__assign({ shop: session.shop }, data))];
                case 5:
                    response = _d.sent();
                    return [2 /*return*/, __assign({ _action: _action }, response)];
                case 6:
                    if (!(_action === _actions_1.ACTIONS.get_MarketsSyncStatus)) return [3 /*break*/, 8];
                    return [4 /*yield*/, db_queries_server_1.getMarketSyncStatus({ shop: session.shop })];
                case 7:
                    response = _d.sent();
                    return [2 /*return*/, __assign({ _action: _action }, response)];
                case 8:
                    if (!(_action === _actions_1.ACTIONS.update_MarketsWidget)) return [3 /*break*/, 10];
                    return [4 /*yield*/, db_queries_server_1.updateMarketsWidget({ shop: session.shop, widget: data.widget })];
                case 9:
                    response = _d.sent();
                    return [2 /*return*/, __assign({ _action: _action }, response)];
