        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 5:
                    ...
                    return [2 /*return*/, __assign({ _action: _action }, response)];
                case 6:
                    if (!(_action === _actions_1.ACTIONS.create_AllowedPages)) return [3 /*break*/, 8];
                    return [4 /*yield*/, db_queries_server_1.createUpdateAllowedPages(__assign({ shop: session.shop }, data))];
                case 7:
                    response = _d.sent();
                    return [2 /*return*/, __assign({ _action: _action }, response)];
                case 8:
                    if (!(_action === _actions_1.ACTIONS.update_WidgetDisplayCustomRuleStatus)) return [3 /*break*/, 10];
                    return [4 /*yield*/, admin_queries_server_1.updateWidgetEditorStatus({ admin: admin, appId: data.appId, value: data.data })];
                case 9:
                    response = _d.sent();
                    return [2 /*return*/, __assign({ _action: _action }, response)];
                case 10:
                    if (!(_action === _actions_1.ACTIONS.update_WidgetDisplayCustomRuleCode)) return [3 /*break*/, 12];
