...
function handleActions(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var admin, _b, _action, data, response, response;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    if (!(_action === _actions_1.ACTIONS.update_AutoRedirectsCustomCodeStatus)) return [3 /*break*/, 4];
                ...
                case 4:
                    if (!(_action === _actions_1.ACTIONS.update_AutoRedirectsCustomCode)) return [3 /*break*/, 6];
